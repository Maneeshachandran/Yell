               ...
               <Accordion.Title active={this.state.activeIndexAccordion === key} index={key} onClick={this.handleClick.bind(this,key)}>
                 <Grid>
                   <Grid.Row style={{padding:0}}>
                     ...
                     <Grid.Column width={4} style={{marginTop:'2%'}}>
                       <span style={{fontWeight:'bold',padding:20,cursor:'pointer'}}>edit</span>
                     </Grid.Column>
                      <Grid.Column width={1} style={{marginTop:'3%',marginLeft:'5%'}}>
                        <Icon name='dropdown' style={{float:'right'}}/>
                      </Grid.Column>
              ...
              <Grid padded>
                <Grid.Row>
                  ...
                  <Grid.Column width={14} >
                    <center>
                      <h3>Guildford Plumbing Co. Ltd</h3>
                  </center>
                  </Grid.Column>
                  <Grid.Column width={1} />
                </Grid.Row>
                <Grid.Row columns={3}>
                  <Grid.Column>
                      <InfoBox number={'05'} text={'E-contracts awaiting sign off'} color={'#1cbfb1'} tagLine={''} />
                  </Grid.Column>
                ...
                <Grid.Row style={{marginTop:-10}}>
                  <Grid.Column width={16} style={{backgroundColor:'#FBBD08'}}>
                ...
                <Grid.Row>
                  <Grid.Column width={16} style={{marginTop:'-25px'}}>
                    <Menu pointing secondary fluid widths={4} color={'orange'}>
                      <Menu.Item name='Yell.com' active={activeItem ==='Yell.com' } onClick={this.handleItemClick.bind(this)} style={{fontSize:'13px'}}>
                        Yell.com (10)
                      </Menu.Item>
                      <Menu.Item name='Connect' active={activeItem === 'Connect'} onClick={this.handleItemClick.bind(this)} style={{fontSize:'13px'}}>
                        Connect (3)
                      </Menu.Item>
                      <Menu.Item name='Reputation' active={activeItem === 'Reputation'} onClick={this.handleItemClick.bind(this)} style={{fontSize:'13px'}}>
                        Reputation (3)
                      </Menu.Item>
                      <Menu.Item name='Freelistings' active={activeItem === 'Freelistings'} onClick={this.handleItemClick.bind(this)} style={{fontSize:'13px'}}>
                        Freelistings
                      </Menu.Item>
                    </Menu>
                  </Grid.Column>
                    ...
                    <SwipeableViews index={this.state.index} disabled={true}>
                      <div style={{overflow:'hidden'}}>
                        ...
                        <SwipeableViews onChangeIndex={(index)=>{this.setState({graphIndex:index})}}>
                          ...
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph2Data} heading={'Clicks'} count={205} icon={'pointing up'} color={['#ed9147']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph3Data} heading={'Activities'} count={561} icon={'cubes'} color={['#269e1e']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph4Data} heading={'Impression'} count={21010} icon={'eye'} color={['#e0c10f']} width={300} height={180}/>
                          </div>
                        </SwipeableViews>
                      ...
                      <div style={{overflow:'hidden'}}>
                        ...
                        <SwipeableViews onChangeIndex={(index)=>{this.setState({graphIndex:index})}}>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph2Data} heading={'Calls'} count={502} icon={'mobile'} color={['#0083CA']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph4Data} heading={'Clicks'} count={230} icon={'pointing up'} color={['#ed9147']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph1Data} heading={'Activities'} count={390} icon={'cubes'} color={['#269e1e']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                      ...
                      <div style={{overflow:'hidden'}}>
                        ...
                        <SwipeableViews onChangeIndex={(index)=>{this.setState({graphIndex:index})}}>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph4Data} heading={'Calls'} count={342} icon={'mobile'} color={['#0083CA']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph3Data} heading={'Clicks'} count={265} icon={'pointing up'} color={['#ed9147']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph2Data} heading={'Activities'} count={470} icon={'cubes'} color={['#269e1e']} width={300} height={180}/>
                          </div>
                          <div style={{overflow:'hidden'}}>
                            <Charts graphData={Graph1Data} heading={'Impression'} count={22010} icon={'eye'} color={['#e0c10f']} width={300} height={180}/>
                          </div>
                        </SwipeableViews>
