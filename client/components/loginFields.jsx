...
import {Grid,Input,Checkbox,Button,Icon,Image,Divider,Form,Modal} from 'semantic-ui-react';
          ...
          <Grid.Row>
            ...
            <Grid.Column width ={5}>
              <Form>
                ...
                <Form.Field>
                    <Input fluid placeholder='abc@xyz.com' onChange={this.handleEmail}/>
                </Form.Field>
                <Form.Field>
                ...
                <Grid>
                  <Grid.Row>
                    <Grid.Column width={16}>
                      <Divider horizontal style={{textTransform:'none'}}>Or connect with</Divider>
                    </Grid.Column>
                 </Grid.Row>
