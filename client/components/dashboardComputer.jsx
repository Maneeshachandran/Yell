      ...
      return(
        <Table.Row key={key}>
           <Table.Cell collapsing style={{padding:0}}>
             <div style={{padding:3,backgroundColor:color,height:48,float:'left',marginRight:5}}>
             </div>
             {item.action == 'Make Payment' ?
             <div style={{padding:15}}>{today}</div>
             :
             <div style={{padding:15}}>{item.date}</div>
           }
           </Table.Cell>
            ...
            <Grid>
              <Grid.Row>
                ...
                <Grid.Column width={5} style={{marginTop:15}}>
                    <center>
                    <span style={styles.headingText}>Guildford Plumbing Co. Ltd</span>
                  </center>
                </Grid.Column>
