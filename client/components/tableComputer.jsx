   ...
   freelistingsData.map((item,key)=>{
     ...
     return(
       <Table.Row key={key}>
          ...
          <Table.Cell style={{cursor:'pointer'}}>edit</Table.Cell>
        </Table.Row>
      );
         ...
         if(key <= 5)
         {
           return(
             <Table.Row key={key}>
                ...
                <Table.Cell style={{cursor:'pointer',width:'25%'}} >{item.name}</Table.Cell>
                <Table.Cell>{item.order}</Table.Cell>
            ...
            <Grid>
                ...
                <SwipeableViews index={this.state.graphIndex}>
                  <div style={{overflow:'hidden'}}>
                    ...
                    <Grid>
                      <Grid.Row >
                        ...
                        <Grid.Column width={7}>
                          <Charts graphData={Graph2Data} width={350} height={200} heading={'Clicks'} count={205} icon={'pointing up'} color={['#ed9147']}/>
                        </Grid.Column>
                  ...
                  <div style={{overflow:'hidden'}}>
                    <Grid>
                      <Grid.Row >
                        <Grid.Column width={6}>
                          <center><Charts graphData={Graph3Data} width={350} height={200} heading={'Impression'} count={21010} icon={'eye'} color={['#e0c10f']}/></center>
                        </Grid.Column>
              ...
              <Grid.Row>
                <Grid.Column width={16}>
                  <Button color='orange' floated='right' disabled = {!this.state.checkBox}>Multi Edit</Button>
                    <Table celled >
                       <Table.Header>
                         <Table.Row>
                  ...
                  <div style={{overflow:'hidden'}}>
                    ...
                    <Grid>
                      <Grid.Row >
                        ...
                        <Grid.Column width={6}>
                          <Charts graphData={Graph4Data} width={350} height={200} heading={'Calls'} count={502} icon={'mobile'} color={['#0083CA']}/>
                        </Grid.Column>

                        <Grid.Column width={7}>
                          <Charts graphData={Graph1Data} width={350} height={200} heading={'Clicks'} count={230} icon={'pointing up'} color={['#ed9147']}/>
                        </Grid.Column>
                  ...
                  <div style={{overflow:'hidden'}}>
                    <Grid>
                      <Grid.Row >
                        ...
                        <Grid.Column width={7}>
                          <center><Charts graphData={Graph3Data} width={350} height={200} heading={'Activities'} count={390} icon={'cubes'} color={['#269e1e']}/></center>
                        </Grid.Column>
                      </Grid.Row>
                    </Grid>
                  </div>
                ...
                <SwipeableViews index={this.state.graphIndex}>
                  <div style={{overflow:'hidden'}}>
                    ...
                    <Grid>
                      <Grid.Row >
                        ...
                        <Grid.Column width={6}>
                          <Charts graphData={Graph2Data} width={350} height={200} heading={'Calls'} count={342} icon={'mobile'} color={['#0083CA']}/>
                        </Grid.Column>
                  ...
                  <div style={{overflow:'hidden'}}>
                    <Grid>
                      <Grid.Row >
                        <Grid.Column width={6}>
                          <center><Charts graphData={Graph1Data} width={350} height={200} heading={'Impression'} count={22010} icon={'eye'} color={['#e0c10f']}/></center>
                        </Grid.Column>

                        <Grid.Column width={7}>
                          <center><Charts graphData={Graph3Data} width={350} height={200} heading={'Activities'} count={470} icon={'cubes'} color={['#269e1e']}/></center>
                        </Grid.Column>
                      </Grid.Row>
                    </Grid>
                  </div>
              ...
              <Grid.Row>
                <Grid.Column width={16}>
                  <Segment inverted color={'grey'}>
                    <center>No Performance Data</center>
                  </Segment>
                </Grid.Column>
              </Grid.Row>
            </Grid>
